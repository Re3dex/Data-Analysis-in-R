...
This is a rShiny webapp created by Ammar Khalid, Roll No. 241547086 for the Final Project of STAT-206. Below is the table generated.

```{r table}
renderTable(df2_table)
```

# Percentage White by State {data-navmenu="Plots"}
...
# Percentage Black by State {data-navmenu="Plots"}
